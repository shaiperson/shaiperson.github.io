...
Today I'd like to walk you through how ML Ops, and Palanca's ML Ops solutions in particular, might be of great assistance to an engineering team looking to apply ML to solve a problem.
...
As is probably clear by now, we're pretty confident we'd have been of great help to Riley and the Nicr team. Given the issues they encountered in their application of ML to their product, they would have benefited greatly from bringing ML Ops practices into their development process.
